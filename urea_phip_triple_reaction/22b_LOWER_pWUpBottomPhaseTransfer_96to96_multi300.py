...
destination_wup = containers.load("FluidX_96_small", "B1","pwup rack")
...
for i in range(0, number_rows):
    ...
    p300_multi.transfer(volume_to_dispense, reaction_rack.rows(i).bottom(4), destination_wup.rows(i).top(-10), air_gap = 10, blow_out = True)
robot.home()

...
destination_wup = containers.load("Starlab_96_Square_2mL", "C1")
...
for i in range(0, number_rows):
    ...
    p300_multi.transfer(volume_to_dispense, reaction_rack.rows(i).bottom(), destination_wup.rows(i).top(-5), blow_out = True)
robot.home()

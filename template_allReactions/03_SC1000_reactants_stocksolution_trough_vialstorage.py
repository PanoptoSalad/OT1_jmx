...
def stock_solution_reactants(reactants, solvent):
    ...
    id_header = "reaction"
    solvent_trough_location_header = "reaction solvent location"
    rack_1 = "24_rack1"
    rack_2 = "24_rack2"
    rack_3 = "24_rack3"
    rack_4 = "24_rack4"
    ...
    p1000.pick_up_tip()
    for i, v in enumerate(reactants_df[destination_location_header].tolist()):
        ...
        if reactants_id == rack_1:
            ...
            if vol_to_dispense != 0:
                p1000.transfer(vol_to_dispense, source_trough4row.wells(solvent_trough_location),
    ...
    p1000.drop_tip()
    robot.home()
stock_solution_reactants(reactants_df, reaction_conditions_df)
...
def add_base_reagent(reaction_condition):
    ...
    #source_location3 = [reaction_rack.rows(2).bottom(2)]
            ...
            for i in range (0, 9):
                ...
                p300_multi.distribute(volume_per_reaction, source_location,destination_1, air_gap=10, new_tip='never', blow_out= True)
                p300_multi.distribute(volume_per_reaction, source_location,destination_2, air_gap=10, new_tip='never',blow_out= True)
                p300_multi.distribute(volume_per_reaction, source_location,destination_3, air_gap=10, new_tip='never',blow_out= True)
                p300_multi.drop_tip()

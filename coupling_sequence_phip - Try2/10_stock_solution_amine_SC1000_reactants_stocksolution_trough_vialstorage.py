...
# CSV file data
reactants_df = read_csv(r"C:\Users\opentrons\protocols\GitHub_repos\OT1-coding\coupling_sequence_phip - Try2\csv\Amines for 3rd Ureas.csv")
solvent_df = read_csv(r"C:\Users\opentrons\protocols\GitHub_repos\OT1-coding\coupling_sequence_phip - Try2\csv\solvents.csv")
...
def stock_solution_reactants(reactants, solvent):
    ...
    rack_stock_reactants_1 = containers.load("FluidX_24_2ml", "A1", "R_1")
    rack_stock_reactants_2 = containers.load("FluidX_24_2ml", "A2", "R_2")
    rack_stock_reactants_3 = containers.load("FluidX_24_2ml", "B1", "R_3")
    rack_stock_reactants_4 = containers.load("FluidX_24_2ml", "B2", "R_4")
